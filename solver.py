...
class Solver:
    ...
    def solve_two_robots_routing(self, map_2d, s0, t0, s1, t1, l):
        path_2d = self.find_shortest_path_2d(map_2d, s0, t0, l)
        ...
        map_3d_0_path = mapper.embed_2d_path_in_3d_map(map_3d, path_2d, l)
        map_3d_0_path_fat = mapper.dilate_map_xy(map_3d_0_path, l)
        map_3d_0_path_fat = mapper.embed_2d_path_in_3d_map(map_3d_0_path_fat, path_2d, l + l)

        robot_1_path = self.find_shortest_path_3d(map_3d_0_path_fat, s1, t1)
        map_3d_0_1_path = mapper.embed_path_in_3d_map(map_3d_0_path, robot_1_path, l, 5)

        return map_3d_0_1_path
